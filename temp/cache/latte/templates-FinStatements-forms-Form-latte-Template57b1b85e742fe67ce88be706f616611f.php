<?php
// source: C:\Apache24\htdocs\company\app\presenters/templates/FinStatements/../../../forms/Form.latte

class Template57b1b85e742fe67ce88be706f616611f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('db9d0764f8', 'html')
;
