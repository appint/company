<?php
// source: C:\Apache24\htdocs\company\app\presenters\finStatements/templates/FinStatements/default.latte

class Template898b1d1073b545d09ec6695f1e4934ba extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ada53c2fd3', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb5c6d4ecbbe_content')) { function _lb5c6d4ecbbe_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>    <div class="row">
<?php $_b->templates['ada53c2fd3']->renderChildTemplate('../../../../forms/Form.latte', $template->getParameters()) ?>
    </div>
