<?php
// source: C:\Apache24\htdocs\company\app\presenters/templates/@layout.latte

class Template8849b345d69882f37ecbfff1e0c8b98d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9aff7b9d7a', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lba7275647ab_head')) { function _lba7275647ab_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb8980854d3c_scripts')) { function _lb8980854d3c_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
