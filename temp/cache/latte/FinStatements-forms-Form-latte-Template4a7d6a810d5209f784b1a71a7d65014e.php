<?php
// source: C:\Apache24\htdocs\company\app\presenters\finStatements/templates/FinStatements/../../../../forms/Form.latte

class Template4a7d6a810d5209f784b1a71a7d65014e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a36b942624', 'html')
;
...
<?php $iterations = 0; foreach ($form['partners']->components as $key => $partner) { ?>
            <div class="container-fluid partner">
                ...
                <div class="col-xs-12 col-sm-1 col-md-1">
                    <a class="btn btn-danger" data-delete-confirm href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("deletePartner!", array($key)), ENT_COMPAT) ?>
">-</a> 
                </div>
            </div>
<?php $iterations++; } ?>
