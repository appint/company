<?php
// source: C:\Apache24\htdocs\company\app\presenters/templates/Homepage/../../../forms/Form.latte

class Template9ee473527b379342c66234a06d57b673 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('40117c3815', 'html')
;
...
<?php $iterations = 0; foreach ($form['partners']->components as $partner) { ?>
            <div class="container-fluid partner">
                ...
                <div class="col-xs-12 col-sm-1 col-md-1">
                    <a class="btn btn-danger" href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("deletePartner!", array($partner['id']->value)), ENT_COMPAT) ?>
">-</a> 
                </div>
            </div>
<?php $iterations++; } ?>
